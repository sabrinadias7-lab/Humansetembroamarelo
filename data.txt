...
window.HUMAN_DATA = {
  ...
  setembroAmarelo: {
    ...
    contexto: {
      ...
      resumo: "Setembro Amarelo é uma campanha de conscientização sobre prevenção do suicídio e valorização da vida. O dia 10 de setembro é reconhecido mundialmente como o Dia Mundial de Prevenção do Suicídio.",
      fonte: "Organização Mundial da Saúde",
      fonteUrl: "https://www.who.int/campaigns/world-suicide-prevention-day",
      closing: "Setembro nos convida a falar sobre a vida.\nO cuidado continua quando o mês termina."
    },

    voceSabia: [
      { titulo: "Escutar também é cuidado", texto: "Oferecer presença, escuta sem julgamento e incentivo para buscar apoio pode fazer diferença quando alguém atravessa um momento difícil." },
      { titulo: "Pedir ajuda pode ser um primeiro passo", texto: "Não é preciso esperar uma situação chegar ao limite para conversar com alguém de confiança ou procurar apoio profissional." },
      { titulo: "Cuidado cabe nas pequenas escolhas", texto: "Uma pausa, uma conversa, movimento, descanso e tempo para perceber como você está podem fazer parte do cuidado cotidiano." }
    ],
    ...
    jogos: {
      ...
      encontreEmVoce: {
        ...
        intro: "Encontre as palavras ligadas a cuidado, presença e conexão. Arraste da primeira até a última letra.",
        palavras: ["CUIDADO", "PAUSA", "ESCUTA", "APOIO", "RESPIRO", "TEMPO", "CALMA", "PRESENCA", "CONEXAO", "ACOLHER", "CONVERSA", "DESCANSO"],
        reflexao: "Você encontrou todas. 💛\n\nCuidado também pode estar nas pequenas coisas que fazemos por nós e pelas pessoas ao nosso redor."
      },
    ...
    /* ---------------------------------------------------------------
       ...
       --------------------------------------------------------------- */
    apoio: {
      title: "Precisa conversar com alguém?",
      text: "Se você precisa de apoio emocional, o CVV oferece escuta voluntária, gratuita e sigilosa. Este é um canal externo ao HUMAN.",
      canais: [
    ...
    feedback: {
      ...
      text: "Uma palavra, um pensamento ou algo que esta experiência despertou em você. O envio é anônimo.",
      placeholderMsg: "Escreva aqui...",
      cta: "Enviar mensagem",
      confirmacao: "Obrigado por compartilhar. 💛\nColocar em palavras também pode ser uma forma de perceber o que este momento despertou em você."
    },
